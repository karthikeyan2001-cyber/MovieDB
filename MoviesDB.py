...
cursor.execute('''INSERT INTO movies(id, Movie_Name, Lead_Actor, Lead_Actress, Director_Name,Year_Of_Release) VALUES(1,"Enthiran","Rajnikanth","Aishwarya Rai","Shankar",2008)''')
cursor.execute('''INSERT INTO movies(id, Movie_Name, Lead_Actor, Lead_Actress, Director_Name,Year_Of_Release) VALUES(2,"Virumaandi","Kamal Haasan","Abhirami","Kamal Haasan",2004)''')
